...
with DAG(
    ...
    description="Ingest PostgreSQL OLTP tables into MinIO and refresh ClickHouse marts",
    schedule="@daily",
    start_date=datetime(2026, 1, 1),
    catchup=False,
    tags=["ingestion", "lakehouse", "minio", "parquet", "clickhouse"],
) as dag:
    ...
    for table in TABLES_TO_INGEST:
        ...
        extract_task >> convert_task >> refresh_marts_task